<template>
  <div id="file" class="print-container">
  ...
  <div class="position-fixed squared">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li>
            <router-link class="dropdown-item" :to="{ name: 'EditFile', params: { id: id }}">Редактировать <i class="fa fa-pencil-square-o" aria-hidden="true"></i
                ></router-link>          
        </li>
        ...
        <li>
          ...
          <button class="dropdown-item" 
            >Экспорт <i class="fa fa-file-word-o" aria-hidden="true"></i
          ></button>
        </ExportToWord>
        </li>
        <li>
        ...
        <li>
          <a class="dropdown-item" href="#"
            >Удалить <i class="fa fa-trash-o" aria-hidden="true"></i
          ></a>
        </li>
      </ul>
    </div>
