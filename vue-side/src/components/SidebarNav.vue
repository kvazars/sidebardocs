        ...
        <ul class="vsm--menu">
          <SidebarMenuItem v-for="item in menu" :key="item.id" :item="item">
            <template #dropdown-icon="{ isOpen }">
              <button class="btn" data-bs-toggle="dropdown" aria-expanded="false" type="button">
                ...
              </button>
              <ul class="dropdown-menu">
                <li><button class="dropdown-item" @click="editFolder()">Редактировать</button></li>
                <li><button class="dropdown-item" @click="newFolder()">Создать папку</button></li>
                <li><button class="dropdown-item" @click="newFile()">Создать ресурс</button></li>
                <li>
                  <button class="dropdown-item" @click="deleteFolder()">Удалить папку</button>
                </li>
              </ul>
