...
- затем отдельно синхронизирует `public/build` с удалением старых файлов на сервере
- после этого загружает остальную папку `public/` без удаления файлов на сервере
